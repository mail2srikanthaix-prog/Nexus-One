...
export function Sidebar({ currentView, onViewChange, mobileOpen, onMobileClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <motion.aside
        ...
        animate={{
          width: mobileOpen ? 240 : isExpanded ? 240 : 64,
        }}
              ...
              return (
                <li key={item.id}>
                  ...
                  >
                    ...
                    {isActive && (isExpanded || mobileOpen) && (
